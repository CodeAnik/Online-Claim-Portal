<?php
    ...
    $rows=$query_obj->overtime_claim_data($_SESSION['user_id']);
			      ...
			      <td>
			      	<div class="row">
			      		<div class="col-md-6">
                                ...
                                <a href="<?php echo '../view_submitted_form/view_overtime_teaching_claim.php?id='.$row["id"] ?>"><button type="button" class="btn btn-sm btn-primary">
							  		View
								</button></a>
								    ...
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        ...
								        <form method="POST" action="">
				 							...
				 							<a href="<?php echo 'delete_overtime_data.php?id='.$row["id"] ?>">
