<?php
    ...
    $rows=$query_obj->question_claim_data_for_admin($_SESSION['user_id']);
...
<!--           <button type="button" class="button">Dashboard</button>
    ...
    <div class="row">
    	<div class="col">
        <h2 style="background-color:rgb(87, 205, 221); padding: 15px;"><b>Expense Data</b></h2><br>
    	</div>
	</div>
	...
	<div class="container">
             <table class="table table-striped">
                ...
                <tr class="">
                  ...
                  <td ><?php echo $row['cur_month']; ?></td>
                  <td><?php  $res=$query_obj->find_user($row['uploaded_by']); echo $res['username']; ?></td> 
			      <td>
			      	<div class="row">
			      		<div class="col-md-6">
                                ...
                                <a href="<?php echo '../view_submitted_form/view_question_claim.php?id='.$row["id"] ?>">
								    ...
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        ...
								        <form method="POST" action="">
				 							...
				 							<a href="../student/<?php echo 'delete_question_data.php?id='.$row["id"] ?>">
