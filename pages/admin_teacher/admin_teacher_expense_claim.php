<?php
    ...
    $rows=$query_obj->expense_claim_data_for_admin();
			      ...
			      <td>
			      	<div class="row">
			      		<div class="col-md-6">
                                ...
                                <a href="<?php echo '../view_submitted_form/view_expense_claim.php?id='.$row["id"] ?>"><button type="button" class="btn btn-sm btn-primary">
                                    View
                                </button></a>
								    ...
								    <div class="modal-content">
								      ...
								      <div class="modal-footer">
								        ...
								        <form method="POST" action="">
				 							<a href="../student/<?php echo 'delete_expense_data.php?id='.$row["id"] ?>">
